...
enum class ErrorType {
  ...
  PMT_HV_INVALID_CHANNEL = 24,
  TRIGGER_SETUP_ERROR = 25,
  TOO_FEW_EVENTS_DETECTED = 26,
  SEND_TELEMETRY_SERIAL_COMMUNICATION_ERROR = 27,
  SEND_TELEMETRY_SWRITE_ERROR = 28,
  SHUTDOWN_REJECTED = 29,
  REBOOT_REJECTED = 30,
